...
#define SDIO_DEBUG_ON                  1
#define SDIO_DEBUG_ARRAY_ON            1
#define SDIO_DEBUG_FUNC_ON             1
   
   
// Log define
#define SDIO_INFO(fmt,arg...)          printf("<<-SDIO-INFO->> "fmt"\n",##arg)
#define SDIO_ERROR(fmt,arg...)         printf("<<-SDIO-ERROR->> "fmt"\n",##arg)
#define SDIO_DEBUG(fmt,arg...)         do{\
                                         if(SDIO_DEBUG_ON)\
                                         printf("<<-SDIO-DEBUG->> [%d]"fmt"\n",__LINE__, ##arg);\
                                       }while(0)
#define SDIO_DEBUG_ARRAY(array, num)   do{\
                                         int32_t i;\
                                         uint8_t* a = array;\
                                         if(SDIO_DEBUG_ARRAY_ON)\
                                         {\
                                            printf("<<-SDIO-DEBUG-ARRAY->>\n");\
                                            for (i = 0; i < (num); i++)\
                                            {\
                                                printf("%02x   ", (a)[i]);\
                                                if ((i + 1 ) %10 == 0)\
...
#define SDIO_DEBUG_FUNC()              do{\
                                         if(SDIO_DEBUG_FUNC_ON)\
                                         printf("<<-SDIO-FUNC->> Func:%s@Line:%d\n",__func__,__LINE__);\
                                       }while(0)
