...
void cpu_flash_test(u16 x, u16 y)
{
	...
	LCD_ShowString(x,y+20,200,16,16,"FLASH Write Finished!");//提示传送完成
	LCD_ShowString(x,y+40,200,16,16,"Start Read FLASH.... ");
	bsp_ReadCpuFlash(FLASH_SAVE_ADDR,(u32*)datatemp,SIZE);
	LCD_ShowString(x,y+60,200,16,16,"The Data Readed Is:  ");//提示传送完成
	LCD_ShowString(x,y+80,200,16,16,datatemp);//显示读到的字符串
}
