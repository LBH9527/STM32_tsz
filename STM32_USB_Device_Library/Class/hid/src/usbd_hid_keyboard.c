...
__ALIGN_BEGIN static uint32_t  USBD_HID_IdleState __ALIGN_END = 0;
  ...
  #endif
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */ 
/* USB HID device Configuration Descriptor */       //设备描述符
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x02,         /*bNumEndpoints*/                                               //1--->2 增加一个输出端点
  0x03,         /*bInterfaceClass: HID*/
  0x01,         /*bInterfaceSubClass : 1=BOOT, 0=no boot*/
  0x01,         /*nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse*/            //2--->1 改为keyboard
  ...
  0x00,
  /******************** Descriptor of Mouse endpoint ********************/      //端点描述符
  /* 27 */
  ...
  HID_IN_PACKET, /*wMaxPacketSize: 8 Byte max */                                //4--->8 增加端点支持的最大包长度
  0x00,
  ...
  /* 41 */
    ...
    #pragma data_alignment=4   
  #endif
/* USB HID device Configuration Descriptor */               //HID描述符
